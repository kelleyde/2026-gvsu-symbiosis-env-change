...
base_slurm_script_fpath = f"/mnt/home/kelleyde/research/{project_name}/experiments/{experiment_name}/hpc/base_slurm_script.txt"
...
combos.add_val(
    "symbiont__COPY_OVER",
    [
        "-START_MOI 0 -HEALTH_TYPE mutualist -VERTICAL_TRANSMISSION 1",
    ]
)
...
combos.add_val(
    ...
    [
        ...
        "events-fluctuating-500.json",
        "events-fluctuating-1000.json"
    ]
)
